...
function jogar() {
  ...
  if (cartas.length == 0){
    ...
    if (pontosJogador> pontosMaquina){
      htmlResultado= '<p class="resultado-final">Venceu, Parabéns</p>'
    }else if (pontosJogador== pontosMaquina){
      htmlResultado= '<p class="resultado-final">Empatou, continue treinando</p>'      
    }
    else{
      htmlResultado= '<p class="resultado-final">Perdeu, melhor sorte na próxima!</p>'      
    }
  }else{
